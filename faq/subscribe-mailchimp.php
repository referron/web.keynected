<?php
  ...
  define('MAILCHIMP_API_KEY', 'a93732e6e76ae53844ce25b2fa830d5f-us3');
  
  // ENTER LIST ID THO WHICH VISITORS ARE SUBSCRIBING
  define('MAILCHIMP_LIST_NAME', 'Register your interest'); //ca9ed3184c
  ...
  // MAILCHIMP LIST CHECK
  $api = new MCAPI(MAILCHIMP_API_KEY);
  $listId = $api->lists(array('list_name' => MAILCHIMP_LIST_NAME), 0, 1);
...
//  MAILCHIMP API (DO NOT EDIT OR DELETE THIS)
class MCAPI {
    var $version = "1.3";
    var $errorMessage;
    var $errorCode;
